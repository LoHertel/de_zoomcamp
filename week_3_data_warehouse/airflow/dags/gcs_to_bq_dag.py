...
DATASET = "tripdata"
DATA_PREFIX = {'yellow': 'tpep_pickup_datetime', 'green': 'lpep_pickup_datetime', 'fhv': 'Pickup_datetime'}
INPUT_PART = "raw"
...
with DAG(
    ...
    for prefix, ds_col in DATA_PREFIX.items():
        ...
        bigquery_external_table_task = BigQueryCreateExternalTableOperator(
            ...
            table_resource={
                ...
                "externalDataConfiguration": {
                    "sourceFormat": INPUT_FILETYPE.upper(), # PARQUET (upper-case, field is case sensitive)
        ...
        CREATE_BQ_TBL_QUERY = (
            f"CREATE OR REPLACE TABLE {BIGQUERY_DATASET}.{prefix}_{DATASET} \
